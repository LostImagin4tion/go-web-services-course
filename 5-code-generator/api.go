...
// код, созданный вашим кодогенератором работает с конкретной структурой, про другие ничего не знает
// поэтому то что рядом есть ещё похожая структура с такими же методами его нисколько не смущает
